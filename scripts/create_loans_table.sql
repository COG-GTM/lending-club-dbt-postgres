-- Raw landing table for dataset/loan.csv (Lending Club extract).
-- All columns land as text: the extract uses the string sentinel 'NA' for missing
-- values, so typing happens in dbt (ELT) rather than at load time.
